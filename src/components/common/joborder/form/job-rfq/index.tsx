...
const RFQForm = ({
  ...
  `
    ...
    .join("")}
      ...
      We are looking forward to your offer and like to thank you for your assistance.<br/><br/><div style="display:flex;gap:20px"><div><p style="font-weight: 700;color:#008ac9;font-size:20;margin:0">${
        user?.fullname
      }</p>Startup Sync<br/><br/><p style="margin:0;padding:0">${
            user?.designation
          }</p><p style="margin:0;padding:0">${
            user?.phone
          }</p><p style="margin:0;padding:0;color:#008ac9;">Email: company@email.com</p><p style="color:#008ac9;padding:0;margin:0;">Indian Institute of Information Technology, Lucknow</p>Tel: +91 - 7848989443<br/></div></div>`,
        };
      })
    );
